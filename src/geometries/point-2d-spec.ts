...
//     let webglRenderSpy: WebGL2RenderingContext;
//     let webglProgramSpy: WebGLProgram;
//     const startingX = 100;
//     const startingY = 150;

//     beforeEach(() => {
//         webglRenderSpy = jasmine.createSpyObj('WebGL2RenderingContext', ['getAttribLocation', 'createVertexArray']);
//         webglProgramSpy = jasmine.createSpyObj('WebGLProgram', ['createProgram']);

//         testPoint = new Point2D(startingX, startingY, webglRenderSpy, webglProgramSpy);
