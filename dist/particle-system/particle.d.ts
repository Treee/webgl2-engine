...
export declare class Particle extends Renderable {
    ...
    isActive: boolean;
    decay: number;
    constructor(position: Vec3 | undefined, velocity: Vec3 | undefined, color: Vec4 | undefined, decay: number | undefined, gl: WebGL2RenderingContext, programInfo: ProgramInfo);
